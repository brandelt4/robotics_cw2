    ...
    def checkIfPathCurrentPathIsStillGood(self):
        ...
        for waypoint in self.currentPlannedPath.waypoints:
            ...
            if self.occupancyGrid.getCell(waypoint.coords[0], waypoint.coords[1]) == 1.0:
                ...
                goalCellCoords = self.occupancyGrid.getCellCoordinatesFromWorldCoordinates((self.currentPlannedPath.waypoints[len(self.currentPlannedPath.waypoints)].coords[0], self.currentPlannedPath.waypoints[len(self.currentPlannedPath.waypoints)].coords[1]))
